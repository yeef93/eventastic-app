...
const EventForm: React.FC<EventFormProps> = ({ initialValues, onSubmit, isEditMode = false }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6 text-center">{isEditMode ? 'Edit Event' : 'Create Event'}</h2>
