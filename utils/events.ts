...
export default [
  {
    ...
    isFree: true,
    ticketTypes: [
      { name: "Free", description:"Free entry", price: 0, seatLimit: 500, availableSeat: 5 }
    ],
    eventCategory: "Sport"
  },
  {
    ...
    location: "Batam",
    venue: "https://maps.app.goo.gl/6NqtyQo48aVK19Nu9",
    imageUrl: "https://images.pexels.com/photos/1547813/pexels-photo-1547813.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    dateTime: "Saturday, June 25, 2024 | 10:00 AM - 2:00 PM",
    availableSeat: 10,
    seatLimit: 100,
    isFree: false,
    ticketTypes: [
      { name: "vip", description:"vip", price: 300000, seatLimit: 50, availableSeat: 3 },
      { name: "reguler", description:"reguler", price: 70000, seatLimit: 100, availableSeat: 5 }
    ],
    eventCategory: "Sport"
  },
  {
    ...
    isFree: false,
    ticketTypes: [
      { name: "vip", description:"vip", price: 800000, seatLimit: 800, availableSeat: 50 },
      { name: "reguler", description:"reguler", price: 40000, seatLimit: 500, availableSeat: 40 }
    ],
  ...
  },
  {
    ...
    isFree: false,
    ticketTypes: [
      { name: "vip", description:"vip", price: 750000, seatLimit: 500, availableSeat: 58 },
      { name: "reguler", description:"reguler", price: 60000, seatLimit: 100, availableSeat: 52 }
    ],
    eventCategory: "Sport"
  },
  {
    ...
    isFree: false,
    ticketTypes: [
      { name: "vip", description:"vip", price: 800000, seatLimit: 100, availableSeat: 45 },
      { name: "reguler", description:"reguler", price: 50000, seatLimit: 500, availableSeat: 65 }
    ],
    eventCategory: "Technology"
  },
  {
    ...
    isFree: false,
    ticketTypes: [
      { name: "vip", description:"vip", price: 900000, seatLimit: 200, availableSeat: 75 },
      { name: "reguler", description:"reguler", price: 45000, seatLimit: 100, availableSeat: 85 }
    ],
    eventCategory: "Sport"
  }
];
