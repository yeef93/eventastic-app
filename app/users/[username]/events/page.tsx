...
function Events() {
      ...
      const fetchTickets = async () => {
        try {
          ...
          if (!response.ok) {
            ...
            throw new Error(errorMessage.statusMessage || "Failed to fetch tickets");
          }
  ...
  const events = tickets.reduce((acc: { [key: string]: Ticket[] }, ticket: Ticket) => {
