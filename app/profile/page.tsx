...
import { BadgeCheckIcon, CalendarIcon, DesktopComputerIcon, LockClosedIcon, LogoutIcon, PresentationChartLineIcon, TicketIcon, UserIcon } from "@heroicons/react/outline";
function Profile() {
  return (
